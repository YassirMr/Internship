...
print("Percentage of accuracy for skewness is")
#print(1-(sum(test_skew)/len(test_skew)))    #NLOS
print(sum(test_skew)/len(test_skew))

print("Percentage of accuracy for K-factor is")
#print(1-(sum(test_kfactor)/len(test_kfactor)))    #NLOS
print(sum(test_kfactor)/len(test_kfactor))
